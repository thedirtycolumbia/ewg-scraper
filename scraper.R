...
scrape_tables(s, "top_recipientz.csv")

# loading the data back into R looks like:
# df <- read.csv("filename.csv", header = F, col.names = c("rank", "recipient", "location", "subtotal"))